        ...
        <div className="flex min-h-screen bg-white">
            <div className="flex flex-1 flex-col justify-center px-8 sm:px-16 md:px-24 lg:px-32">
                <div className="w-full max-w-[400px] mx-auto">
                    <h1 className="text-3xl font-bold text-gray-900 mb-8 tracking-tight">Get Started Now</h1>
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        <div className="space-y-1">
                            <label className="text-sm font-bold text-black tracking-normal">Name</label>
                            <input
                        ...
                        <div className="flex items-center mt-2">
                            ...
                            />
                            <label htmlFor="terms" className="ml-2 block text-xs text-black font-semibold">
            ...
            <div className="hidden lg:block lg:flex-1 relative p-2 pr-2">
                <div className="relative w-full h-full rounded-2xl overflow-hidden bg-[#f5f5f5]">
                    <Image src="/bg-leaves.png" alt="Leaves background" fill className="object-cover" priority />
                </div>
            </div>
        </div>
    );
